...
# Bounties 
## Bugs
- [ ] evaluate CSP is a mess, please invistigate and create more bounties to fix the issue.
...
- [ ] invistigate evaluate solving csp using local search does not make much progress.
